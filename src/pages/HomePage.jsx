...
export default function HomePage() {
  ...
  const handleMouseMove = useCallback((e) => {
    ...
    gsap.timeline({ onComplete: () => el.remove() })
      ...
      .to(el, { opacity: 0, scale: 0.7, y: -18, duration: 0.4, ease: "power2.in" }, "+=1.6");
  }, []);
    ...
    <div className="home-root" ref={rootRef} onMouseMove={handleMouseMove}>
      ...
      <main className="hero">
        ...
        <div className="role-buttons" ref={btnsRef}>
          <button className="role-btn" onClick={() => navigate("/doctor")}>Doctor</button>
          <button className="role-btn" onClick={() => navigate("/patient")}>Patient</button>
          <button className="role-btn" onClick={() => navigate("/pharmacist")}>Pharmacist</button>
        </div>
